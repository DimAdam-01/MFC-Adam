...
_mfc_completions() {
    ...
    local commands="b bench bench_diff build c clean completion count count_diff format generate help interactive lint load new packer params precheck r run spelling t test v validate"
