...
#:def Hardcoded2D()
  ...
  case (270)
      ...
      q_prim_vf(1)%sf(i,j,0) =P_ref 0.5_wp * ((rho_F + rho_O) + &
                                        (rho_F - rho_O) * &
        ...
        q_prim_vf(4)%sf(i,j,0) = 101325.0_wp
